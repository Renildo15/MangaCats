...
urlpatterns = [
    ...
    path("previous_chapter/<str:pk>/<str:name>/", page_views.previous_chapter, name="previous_chapter"),
    path("next_chapter/<str:pk>/<str:name>/", page_views.next_chapter, name="next_chapter")
]
